...
from constants import (
    CH_GPS_FIX, CH_LAP_NUMBER, CH_GPS_ACCURACY, CH_RUNNING_TIME, CH_CORR_DIST,
    CH_DEVICE_BATTERY, CH_THROTTLE_POS, CH_BRAKE_POS, CH_GEAR, CH_YAW_RATE,
    CH_CG_ACCEL_LAT, CH_CG_ACCEL_LON, CH_GROUND_SPEED, CH_GPS_LATITUDE,
    CH_GPS_LONGITUDE, CH_GPS_HEADING, CH_GPS_ALTITUDE, CH_ENGINE_RPM,
    CH_STEERING_ANGLE, CH_COOLANT_TEMP, CH_ENGINE_OIL_TEMP, CH_LEAN_ANGLE, CH_BRAKE_PRESS,
